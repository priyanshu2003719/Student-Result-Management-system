...
class Clock:
    ...
    def clock_image(self, hr, min_, sec_):
        ...
        origin=200,200
        draw.line((origin, 200+50*math.sin(math.radians(hr)), 200-50*math.cos(math.radians(hr))), fill="black", width=4)
        draw.line((origin, 200+80*math.sin(math.radians(min_)), 200-80*math.cos(math.radians(min_))), fill="blue", width=3)
        draw.line((origin, 200+100*math.sin(math.radians(sec_)), 200-100*math.cos(math.radians(sec_))), fill="green", width=4)
